...
public class SaleDashboardService {
	...
	public List<ItemTypeSummaryDetail> itemTypeSummaryByBranchId(Integer branchId, Date startDate, Date startWeek,
		...
		return branchRepository.findById(branchId).map((branch) -> {
			...
			return jdbc.query("select * from itemtypesummarybybranchid(:branchId,:startDate,:startWeek,:endDate)", mapSqlParameterSource,
	...
	public List<ItemTypeSummaryDetail> itemTypeSummaryByCopId(Integer corporateId, Date startDate, Date startWeek,
		...
		mapSqlParameterSource.addValue("startWeek", startWeek);
		mapSqlParameterSource.addValue("corporateId", corporateId);
		return jdbc.query("select * from itemtypesummarybycopid(:corporateId,:startDate,:startWeek,:endDate)", mapSqlParameterSource,
				(rs, rowNum) -> new ItemTypeSummaryDetail(rs.getLong("itemTypeId"), rs.getString("itemTypeName"),
						rs.getString("itemTypeKh"), rs.getInt("monthly_sale"), rs.getInt("weekly_sale"),
						rs.getInt("daily_sale"), rs.getDouble("monthly_sale_amount"),
						rs.getDouble("weekly_sale_amount"), rs.getDouble("daily_sale_amount")));
	}
	public List<ItemTypeSummaryChart> itemTypeChartByBranchId(Integer branchId, Date startDate,
			Date endDate) {
		...
		mapSqlParameterSource.addValue("branchId", branchId);
		return jdbc.query(
				"select * from itemTypeChartByBranchId(:branchId,:startDate,:endDate)",
				mapSqlParameterSource, (rs, rowNum) -> new ItemTypeSummaryChart(rs.getInt("itemTypeId"),
						rs.getString("itemTypeName"), rs.getString("itemTypeKh"), rs.getDouble("saleAmt"),rs.getInt("saleItem")));
	}
	public List<ItemTypeSummaryChart> itemTypeChartByCopId(Integer corporateId, Date startDate,
			Date endDate) {
		if (userProfile.getProfile().getCorporate().getId() != corporateId) {
			throw new UnauthorizedException("Corporate is unauthorized");
		}
		...
		mapSqlParameterSource.addValue("corporateId", corporateId);
		return jdbc.query(
				"select * from itemTypeChartByCopId(:corporateId,:startDate,:endDate)",
				mapSqlParameterSource, (rs, rowNum) -> new ItemTypeSummaryChart(rs.getInt("itemTypeId"),
						rs.getString("itemTypeName"), rs.getString("itemTypeKh"), rs.getDouble("saleAmt"),rs.getInt("saleItem")));
	}
	...
	public List<ItemSummaryChart> itemChartByBranchId(Integer branchId, Date startDate,
			Date endDate) {
		if (userProfile.getProfile().getBranch().getId() != branchId) {
			throw new UnauthorizedException("You are unauthorized");
		}
		...
		mapSqlParameterSource.addValue("branchId", branchId);
		return jdbc.query(
				"select * from itemChartByBranchId(:branchId,:startDate,:endDate)",
				mapSqlParameterSource, (rs, rowNum) -> new ItemSummaryChart(rs.getLong("itemId"),
						rs.getString("itemName"), rs.getString("itemKh"), rs.getDouble("saleAmt"),rs.getInt("saleItem")));
	}
	public List<ItemSummaryChart> itemChartByCopId(Integer copId, Date startDate,
			Date endDate) {
		...
		return jdbc.query(
				"select * from itemChartByCopId(:copId,:startDate,:endDate)",
				mapSqlParameterSource, (rs, rowNum) -> new ItemSummaryChart(rs.getLong("itemId"),
						rs.getString("itemName"), rs.getString("itemKh"), rs.getDouble("saleAmt"),rs.getInt("saleItem")));
	}
