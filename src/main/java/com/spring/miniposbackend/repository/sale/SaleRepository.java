...
public interface SaleRepository extends JpaRepository<Sale, Long> {
	 ...
	 @Query(value = "select s from Sale s where s.user.id = ?1 and  value_date between ?2 and ?3")
	 ...
	 @Query(value = "select s from Sale s where s.user.id = ?1 and  value_date between ?2 and ?3 and s.paymentChannel.id=null")
	 ...
	 @Query(value = "select s from Sale s where s.user.id = ?1 and  value_date between ?2 and ?4 and s.paymentChannel.id=?3")
	 ...
	 @Query(value = "select s from Sale s where s.branch.id = ?1 and  value_date between ?2 and ?4 and s.paymentChannel.id=?3")
	 ...
	 @Query(value = "select s from Sale s where s.branch.id = ?1 and  value_date between ?2 and ?3 and s.paymentChannel.id=null")
	 ...
	 @Query(value = "select s from Sale s where s.branch.id = ?1 and  value_date between ?2 and ?3")
